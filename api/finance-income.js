// ════════════════════════════════════════════════════════════════════
// POST  /api/finance-income  — create a new manual income entry
// PATCH /api/finance-income  — update or soft-delete an existing entry
// ════════════════════════════════════════════════════════════════════
...
//
// PATCH body (update):
//   { id, date: "YYYY-MM-DD", category, amount, description? }
//
...
const VALID_CATEGORIES = ['Pass Sale','Lesson','Event','Membership','Misc'];
...
export default async function handler(req, res) {
  ...
  try { db = getAdminDb(); }
    ...
    console.error('[finance-income] DB init:', e.message);
